...
describe('QuizInterface Component', () => {
  ...
  it('should handle correct answer selection', async () => {
    ...
    await waitFor(() => {
      ...
      expect(mockProps.onProgress).toHaveBeenCalledWith(1, mockQuestions.length);
    });
  });
  ...
  it('should handle empty question list', () => {
    render(<QuizInterface questions={[]} onComplete={mockProps.onComplete} onProgress={mockProps.onProgress} />);
