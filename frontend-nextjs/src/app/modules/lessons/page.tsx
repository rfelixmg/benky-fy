...
import { BookOpen, ArrowRight, GraduationCap, PenTool, MessageSquare, Brain } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-purple to-secondary-purple relative overflow-hidden">
      ...
      <div className="relative z-10 p-6 flex justify-between items-center">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-primary-foreground">Japanese Lessons</h1>
            <p className="text-primary-foreground/80">Start your structured learning journey</p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {availableLessons.map((lesson) => {
              ...
              return (
                <Card key={lesson.id} className="p-6 bg-background/10 backdrop-blur-sm border-primary-foreground/20">
                  <div className="flex items-center mb-4">
                    <div className={`w-12 h-12 rounded-lg bg-gradient-to-r ${lesson.color} flex items-center justify-center mr-4`}>
                      <IconComponent className="w-6 h-6 text-primary-foreground" />
                    </div>
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-primary-foreground">{lesson.title}</h3>
                  ...
                  <p className="text-primary-foreground/80 mb-4">{lesson.description}</p>
                  ...
                  {lesson.status === 'Coming Soon' ? (
                    ...
                    <Button asChild className="w-full bg-primary-purple hover:bg-primary-purple/90">
          ...
          <div className="mt-12">
            <Card className="p-6 bg-background/10 backdrop-blur-sm border-primary-foreground/20">
              <h3 className="text-xl font-semibold text-primary-foreground mb-4">Learning Path Guide</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-medium text-primary-foreground mb-2">📚 Recommended Order</h4>
                ...
                <div>
                  <h4 className="font-medium text-primary-foreground mb-2">⭐ Study Tips</h4>
